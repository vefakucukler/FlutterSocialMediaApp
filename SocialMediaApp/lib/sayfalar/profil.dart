  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        actions: <Widget>[
          widget.profilSahibiId == _aktifKullaniciId ? IconButton(icon: Icon(Icons.exit_to_app, color: Colors.white,), onPressed: _cikisYap) : SizedBox(height: 0.0,)
        ],
  ...
  Widget _takiptenCikButonu(){
    return Container(
      ...
      child: OutlinedButton(
        ...
        child: Text("Takipten Çık", style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black)),
        ),
    );
  }
